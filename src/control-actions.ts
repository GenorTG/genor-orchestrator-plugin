...
export function controlDir(dataDir: string): string {
  return path.join(dataDir, "control");
}

export function writeActionResult(dataDir: string, actionId: string, ok: boolean, result: any, error: string | null): void {
  try {
...
export function processSetContext(dataDir: string, params: Record<string, any>, logger: OrchestratorLogger): any {
...
export function processClearContext(dataDir: string, _params: Record<string, any>, logger: OrchestratorLogger): any {
...
export function processUpdateRouting(dataDir: string, params: Record<string, any>, logger: OrchestratorLogger): any {
...
export function processControlAction(dataDir: string, action: ControlAction, logger: OrchestratorLogger): void {
  try {
